				...
				<tr>
					...
					<td class="rightTd"><select class="easyui-combobox"
						...
						onChange="changeValue(current,old)">
							...
							<option value="2">AC-DC TIG</option>
							<option value="3">直流TIG</option>
					</select></td>
				...
				<tr>
					...
					<td class="rightTd"><select class="easyui-combobox"
						...
						onChange="changeValue(current,old)">
							...
							<option value="02">软</option>
							<option value="03">硬性</option>
					</select></td>
...
<div id="divro" class="easyui-dialog" style="width:500px;height:490px"
	...
	<div style="text-align:center;height:25px">
		<lable id="mu"></lable>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 所属班组：<select
			class="easyui-combobox" name="item" id="item"
			data-options="editable:false" onChange="changeValue(current,old)"></select>
	</div>
