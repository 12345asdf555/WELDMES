...
function QinTronSAVE(value) {
	...
	if(machineModel == 184){
		...
		url2 = "wps/apSperl" + "?fselect=" + fselect + "&fcharacter=" + fcharacter + "&fmaterial=" + fmaterial + "&fgas=" + fgas + "&fdiameter=" + fdiameter + "&chanel=" + chanel + "&fweld_ele=" + fweld_ele + "&fweld_vol=" + fweld_vol + "&fspeed=" + fspeed + "&farc_tuny_speed=" + farc_tuny_speed + "&farc_speed=" + farc_speed + "&fini_vol=" + fini_vol + "&fini_ele=" + fini_ele + "&farc_ele=" + farc_ele + "&farc_vol=" + farc_vol + "&fadvance=" + fadvance + "&fweld_tuny_vol=" + fweld_tuny_vol + "&fweld_tuny_ele=" + fweld_tuny_ele + "&fselectstep=" + fselectstep + "&frequency=" + frequency + "&ftime=" + ftime + "&machine=" + machine;
	}
	$.ajax({
		type : "post",
		async : false,
