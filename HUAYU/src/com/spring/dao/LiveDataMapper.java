...
public interface LiveDataMapper extends Mapper<LiveData>{
	...
	List<ModelDto> getHuayuLiveMachineCount(@Param("dto")WeldDto dto,@Param("parent")BigInteger parent,@Param("insftype")String insftype);
	...
	List<ModelDto> getComprehensiveTime(@Param("dto")WeldDto dto,@Param("parent") BigInteger parent);
	
	List<ModelDto> getComprehensiveNum(@Param("dto")WeldDto dto,@Param("parent") BigInteger parent);
	
	List<LiveData> getMachineOfHuayu();
	
	String getJunNumByWelderOrMach(@Param("dto")WeldDto dto,@Param("gatherId")String gatherId,@Param("welderId")String welderId);
	
	String getJunNumResult(@Param("dto")WeldDto dto,@Param("gatherId")String gatherId,@Param("welderId")String welderId);
	
	String getMaxNum(@Param("dto")WeldDto dto,@Param("gatherId")String gatherId,@Param("welderId")String welderId);
	
	List<ModelDto> getEverydayCount(@Param("dto")WeldDto dto,@Param("parent")BigInteger parent,@Param("insftype")String insftype);
	
	List<ModelDto> getAllTimeOfKj(@Param("dto")WeldDto dto);
}
