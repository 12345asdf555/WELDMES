...
public class LiveDataServiceImpl implements LiveDataService {
	...
	@Override
	public List<ModelDto> getComprehensiveTime(WeldDto dto, BigInteger parent) {
		// TODO Auto-generated method stub
		return live.getComprehensiveTime(dto, parent);
	}

	@Override
	public List<ModelDto> getComprehensiveNum(WeldDto dto, BigInteger parent) {
		// TODO Auto-generated method stub
		return live.getComprehensiveNum(dto, parent);
	}

	@Override
	public List<LiveData> getMachineOfHuayu() {
		// TODO Auto-generated method stub
		return live.getMachineOfHuayu();
	}

	@Override
	public String getJunNumByWelderOrMach(WeldDto dto,String gatherId, String welderId) {
		// TODO Auto-generated method stub
		return live.getJunNumByWelderOrMach(dto, gatherId, welderId);
	}

	@Override
	public List<ModelDto> getHuayuLiveMachineCount(WeldDto dto, BigInteger parent, String insftype) {
		// TODO Auto-generated method stub
		return live.getHuayuLiveMachineCount(dto, parent, insftype);
	}

	@Override
	public String getJunNumResult(WeldDto dto, String gatherId, String welderId) {
		// TODO Auto-generated method stub
		return live.getJunNumResult(dto, gatherId, welderId);
	}

	@Override
	public String getMaxNum(WeldDto dto, String gatherId, String welderId) {
		// TODO Auto-generated method stub
		return live.getMaxNum(dto, gatherId, welderId);
	}

	@Override
	public List<ModelDto> getEverydayCount(WeldDto dto, BigInteger parent, String insftype) {
		// TODO Auto-generated method stub
		return live.getEverydayCount(dto, parent, insftype);
	}

	@Override
	public List<ModelDto> getAllTimeOfKj(Page page, WeldDto dto) {
		// TODO Auto-generated method stub
		PageHelper.startPage(page.getPageIndex(), page.getPageSize());
		return live.getAllTimeOfKj(dto);
	}

	@Override
	public List<ModelDto> getAllTimeOfKj(WeldDto dto) {
		// TODO Auto-generated method stub
		return live.getAllTimeOfKj(dto);
	}
