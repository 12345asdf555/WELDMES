...
public interface LiveDataService {
	 ...
	 * @return
	 */
	List<ModelDto> getComprehensiveTime(WeldDto dto, BigInteger parent);
	 ...
	 * @return
	 */
	List<ModelDto> getComprehensiveNum(WeldDto dto, BigInteger parent);
	...
	/**
	 * 根据焊工编号或者焊机编号获取前一个小时的工件数量
	 */
	String getJunNumByWelderOrMach(WeldDto dto, String gatherId,String welderId);
	 ...
	 * @return
	 */
	List<ModelDto> getHuayuLiveMachineCount(WeldDto dto,BigInteger parent,String insftype);
	
	/**
	 * 根据焊工编号或者焊机编号获取工件数量
	 */
	String getJunNumResult(WeldDto dto, String gatherId,String welderId);
	
	/**
	 * 获取一段时间内最新的工件数量（华域）
	 */
	String getMaxNum(WeldDto dto, String gatherId,String welderId);

	/**
	 * 获取请求时间段内每一天每台焊机工作的时间
	 * @param dto
	 * @param parent
	 * @param insftype
	 * @return
	 */
	List<ModelDto> getEverydayCount(WeldDto dto, BigInteger parent, String insftype);
	 ...
	 * @return
	 */
	List<ModelDto> getAllTimeOfKj(Page page,WeldDto dto);
	List<ModelDto> getAllTimeOfKj(WeldDto dto);
}
