...
public class WelderServiceImpl implements WelderService {
	...
	@Override
	public Welder getWelderForFid(BigInteger fid) {
		return wm.getWelderForFid(fid);
	}

	@Override
	public BigInteger getWelderIdForWelderNo(String welderno) {
		return wm.getWelderIdForWelderNo(welderno);
	}
}