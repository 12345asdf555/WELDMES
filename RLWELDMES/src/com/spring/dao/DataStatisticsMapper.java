...
public interface DataStatisticsMapper  extends Mapper<DataStatistics>{
	...
	BigInteger getArcairtime(@Param("itemid") BigInteger itemid,@Param("dto") WeldDto dto);
	
	BigInteger getArcairtime1(@Param("itemid") BigInteger itemid,@Param("dto") WeldDto dto);
	
	BigInteger getArcairtime2(@Param("itemid") BigInteger itemid,@Param("dto") WeldDto dto);
	
	BigInteger getArcairtime4(@Param("dto") WeldDto dto);
	
	BigInteger getArcairtime5(@Param("dto") WeldDto dto);
	
	BigInteger getArcairtime6(@Param("dto") WeldDto dto);
