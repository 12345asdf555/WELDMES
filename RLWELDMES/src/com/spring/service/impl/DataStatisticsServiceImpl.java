...
public class DataStatisticsServiceImpl implements DataStatisticsService {
	...
	@Override
	public BigInteger getArcairtime(BigInteger itemid, WeldDto dto) {
		return ds.getArcairtime(itemid, dto);
	}
	
	@Override
	public BigInteger getArcairtime1(BigInteger itemid, WeldDto dto) {
		return ds.getArcairtime1(itemid, dto);
	}
	
	@Override
	public BigInteger getArcairtime2(BigInteger itemid, WeldDto dto) {
		return ds.getArcairtime2(itemid, dto);
	}
	
	@Override
	public BigInteger getArcairtime4(Page page, WeldDto dto) {
		PageHelper.startPage(page.getPageIndex(), page.getPageSize());
		return ds.getArcairtime4(dto);
	}
	@Override
	public BigInteger getArcairtime4(WeldDto dto) {
		return ds.getArcairtime4(dto);
	}
	
	@Override
	public BigInteger getArcairtime5(Page page, WeldDto dto) {
		PageHelper.startPage(page.getPageIndex(), page.getPageSize());
		return ds.getArcairtime5(dto);
	}
	
	@Override
	public BigInteger getArcairtime5(WeldDto dto) {
		return ds.getArcairtime5(dto);
	}
	
	
	@Override
	public BigInteger getArcairtime6(Page page, WeldDto dto) {
		PageHelper.startPage(page.getPageIndex(), page.getPageSize());
		return ds.getArcairtime6(dto);
	}
	
	@Override
	public BigInteger getArcairtime6(WeldDto dto) {
		return ds.getArcairtime6(dto);
	}
	
	@Override
	public BigInteger getArcairtime7(Page page, WeldDto dto) {
		PageHelper.startPage(page.getPageIndex(), page.getPageSize());
		return ds.getArcairtime6(dto);
	}
	
	@Override
	public BigInteger getArcairtime7(WeldDto dto) {
		return ds.getArcairtime6(dto);
	}
