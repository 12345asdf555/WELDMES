...
public interface DataStatisticsService {
	...
	BigInteger getArcairtime(BigInteger itemid,WeldDto dto);
	
	BigInteger getArcairtime1(BigInteger itemid,WeldDto dto);
	
	BigInteger getArcairtime2(BigInteger itemid,WeldDto dto);
	
	BigInteger getArcairtime4(Page page,WeldDto dto);
	
	BigInteger getArcairtime4(WeldDto dto);/*导出时不需要分页*/
	
	BigInteger getArcairtime5(Page page,WeldDto dto);
	BigInteger getArcairtime5(WeldDto dto);/*导出时不需要分页*/
	
	BigInteger getArcairtime6(Page page,WeldDto dto);
	BigInteger getArcairtime6(WeldDto dto);/*导出时不需要分页*/
	
	BigInteger getArcairtime7(Page page,WeldDto dto);
	BigInteger getArcairtime7(WeldDto dto);/*导出时不需要分页*/
	/**
	 * 获取焊接时长，平均电流电压
	 * @param itemid  项目部id
	 * @param dto 扩展参数类
