...
<html>
  <head>
	...
	<script type="text/javascript" src="resources/js/rlIndexs.js"></script>
...
<!--   		<p id="nowTime" style="color: #ffffff;position:absolute;left:10%;top:5%;"></p> -->
  		...
  		<div style="background:url(resources/images/rlIndex.png) no-repeat 4px 5px;position:absolute;left:21%;top:0.5%;height:100px; width:400px;line-height: 100%">
...
<!--   		<div id="div1-1" style="background-color: #11325f;width:30%;height:40%;float:left;position:absolute;left:3%;top:14%;"></div> -->
  		<div id="div1-2" style="background-color: #11325f;width:44%;height:40%;float:left;position:absolute;left:5%;top:14%;"></div>
  		<div id="div1-3" style="background-color: #11325f;width:44%;height:40%;float:left;position:absolute;left:51%;top:14%;"></div>
  		<div id="div2-1" style="background-color: #11325f;width:44%;height:40%;float:left;position:absolute;left:5%;top:57%;"></div>
<!--   		<div id="div2-2" style="background-color: #11325f;width:30%;height:40%;float:left;position:absolute;left:35%;top:57%;">
  		...
  		<div id="div2-3" style="background-color: #11325f;width:44%;height:40%;float:left;position:absolute;left:51%;top:57%;"></div>
  </body>
</html>
