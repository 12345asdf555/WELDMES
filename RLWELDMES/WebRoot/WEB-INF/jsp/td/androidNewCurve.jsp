...
<body class="easyui-layout">
	...
	<div id="bodydiv" region="center"  hide="true"  split="true" title="焊机实时状态监测" style="background: #fff; width:600px;height: 335px;">
		<div style="float:left; width:100%;height:250px;border:1px solid #C4C4C4;">
			<p style="text-align: center;color:#777777;font-size: 12pt">设备总数 ：<span id="machinenum" style="color:#fe0002">0</span>
			<!--	<a href="indexs.jsp" class="easyui-linkbutton" iconCls="icon-newadd" style="position: absolute;left: 90%">返回</a>&nbsp;&nbsp;&nbsp;&nbsp;-->
			</p>
