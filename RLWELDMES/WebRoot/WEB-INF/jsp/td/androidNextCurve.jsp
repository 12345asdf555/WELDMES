...
<%-- 		<div style="float:left; width:100%;height:30px;background-color: #145d92;color:#ffffff;font-size:14px;">设备运行参数监控
		...
		<div style="width:22%;height:150px;float:left;margin-left:20px;position: relative;">
			<fieldset>
				<legend>设备信息</legend>
		...
		<div style="width:20%;height:150px;float:left;margin-left:10px;position: relative;">
			<fieldset>
				<legend>焊接参数</legend>
		...
		<div style="width:12%;height:150px;float:left;margin-left:10px;position: relative;">
			<fieldset>
				<legend>焊接方法</legend>
				<div style="width:95%;height:75px;margin-left:50px;">
					<div style="float:left;background-color: #f08080;width:100px;height:40px;border-radius: 10px;margin-top:10px;font-size:18pt;text-align: center;color:#ffffff">碳弧气刨</div>
				</div>
				<div style="width:100;height:75px;margin-left:50px;">
					<input type="text" readonly="readonly" id="arcair" value="未开启" style="border-radius: 10px;font-size:18pt;width:100px;height:40px;margin-top:-6px;text-align:center;color:#ffffff;background: #818181">
				</div>
			</fieldset>
		</div>
		<div style="width:42%;height:150px;float:left;margin-left:10px;position: relative;">
			<fieldset>
				<legend>设备特征</legend>
...
<!-- 						收弧电流：<span id="r16"></span></li> -->
		...
		<div style="float:left; width:100%;height:20px;margin-top:5px;background-color: #145d92;color:#ffffff;text-align:center;">焊接曲线
			<a href="td/AllTd" class="easyui-linkbutton" iconCls="icon-newadd" style="position: absolute;left: 90%">返回</a>&nbsp;&nbsp;&nbsp;&nbsp;
		</div>
		<div id="livediv" style="width:100%;height:85%;float:left;top:26%;">
