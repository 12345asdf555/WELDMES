  		...
  		<div id="body">
  			...
  			<form id="fm" class="easyui-form" method="post" data-options="novalidate:true">
				...
				<div>
					<table>
						<tr>
							<td id="dadvance" class="leftTd"><lable> <span class="required">*</span>提前送气时间：</lable></td>
							<td id="tadvance" class="rightTd"><input name="fadvance" id="fadvance"
					...
					<table>
						<tr>
							...
							<td id="tfweld_tuny_vol" class="rightTd"><input name="fweld_tuny_vol"
								...
								data-options="required:true">(V)</td>
						</tr>
					</table>
				</div>
				<div>
					<table>
						<tr>
							...
							<td id="tfini_tuny_vol" class="rightTd"><input name="fini_tuny_vol"
								...
								data-options="required:true">(A)</td>
							<td id="rfarc_tuny_vol" class="leftTd"><lable> <span class="required">*</span>收弧电压微调：</lable></td>
					...
					<table aligin="center">
						<tr>
							...
							<td style="text-align: center;width: 350px;">
				  				<a id="buttonCancel" href="javascript:QinTronGET();" class="easyui-linkbutton" iconCls="icon-ok">索取规范</a>
			  					<a href="javascript:QinTronSAVE(0);" class="easyui-linkbutton" iconCls="icon-ok">保存</a>
			  					<a id="buttonOk" href="javascript:QinTronSendCheck();" class="easyui-linkbutton" iconCls="icon-ok">下发规范</a>
