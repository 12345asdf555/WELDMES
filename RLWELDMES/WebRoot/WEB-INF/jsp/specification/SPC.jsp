		...
		<form id="fm" class="easyui-form" method="post"
				...
				<table>
					<tr>
						<td id="dmanual" class="leftTd"><lable>
							<span class="required">*</span>手工焊电流：</lable></td>
						...
						<td id="dmanualarc" class="leftTd"><lable>
							<span class="required">*</span>热引弧电流：</lable></td>
				...
				<table>
					<tr>
						<td id="dmanualtime" class="leftTd"><lable>
							<span class="required">*</span>热引弧时间：</lable></td>
						...
						<td id="dthrust_ele" class="leftTd"><lable>
							<span class="required">*</span>推力电流:</lable></td>
				...
				<table>
					<tr>
						<td id="dfweldparameters" class="leftTd"><lable>
							<span class="required">*</span>焊接方法：</lable></td>
						...
						<td id="dpulse" class="leftTd"><lable>
							<span class="required">*</span>双脉冲：</lable></td>
				...
				<table>
					<tr>
						<td class="leftTd"><lable>
							<span class="required">*</span>焊丝直径：</lable></td>
						<td class="rightTd"><select class="easyui-combobox"
						...
						<td class="leftTd"><lable>
							<span class="required">*</span>一元/个别：</lable></td>
						<td class="rightTd"><select class="easyui-combobox"
			...
			<div id="div-4">
				<table>
					<tr>
						<td class="leftTd"><lable>
							<span class="required">*</span>焊接电流：</lable></td>
						...
						<td id="wv" class="leftTd"><lable>
							<span class="required">*</span>焊接电压：</lable></td>
						...
						<td id="wvo" class="leftTd"><lable>
							<span class="required">*</span>焊接电压(一元)：</lable></td>
			...
			<div id="div-5">
				<table>
					<tr>
						<td class="leftTd"><lable>
							<span class="required">*</span>前气时间：</lable></td>
						<td class="rightTd"><input name="fadvance" id="fadvance"
							class="easyui-numberbox" data-options="required:true,precision:1">(s)</td>
						<td class="leftTd"><lable>
							<span class="required">*</span>延气时间：</lable></td>
				...
				<table>
					<tr>
						...
						<td id="ivo" class="leftTd"><lable>
							<span class="required">*</span>起始电压(一元)：</lable></td>
			...
			<div id="div-7">
				<table>
					<tr>
						<td class="leftTd"><lable>
							<span class="required">*</span>起始时间：</lable></td>
						...
						<td id="drise" class="leftTd"><lable>
							<span class="required">*</span>缓升时间:</lable></td>
				...
				<table>
					<tr>
						<td id="dfrequency" class="leftTd"><lable>
							<span class="required">*</span>双脉冲频率：</lable></td>
						...
						<td id="dpulse_ratio" class="leftTd"><lable>
							<span class="required">*</span>双脉冲占空比:</lable></td>
			...
			<div id="div-12">
				<table>
					<tr>
						<td class="leftTd"><lable>
							<span class="required">*</span>电弧特性：</lable></td>
						...
						<td id="drush" class="leftTd"><lable>
							<span class="required">*</span>回烧修正：</lable></td>
				...
				<div>
					<table>
						<tr>
							...
							<td class="leftTd"><lable>
								<span class="required">*</span>点动送丝速度：</lable></td>
				...
				<table aligin="center">
					<tr>
						...
						<td style="text-align: center;width: 350px;"><a
							...
							iconCls="icon-ok">焊机参数复制</a> <a href="javascript:openCopyDialog(0);"
				...
				<table width="80%" height="30%" border="1"
					...
					<tr height="30px">
						<td colspan="2" align="center"><a
							href="javascript:controlfun();" class="easyui-linkbutton"
							iconCls="icon-ok">下发控制命令</a> <a href="javascript:openPassDlg();"
							class="easyui-linkbutton" iconCls="icon-ok">密码下发</a></td>
					</tr>
				</table>
			</div>
		</form>
